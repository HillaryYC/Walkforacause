        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    @isset($header)
                        <div class="sm:hidden text-base font-semibold text-gray-900 leading-tight">
                            {{ $header }}
                        </div>
                    @endisset
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="mt-3 space-y-1">
                ...
                <form method="POST" action="{{ route('logout') }}" class="flex justify-end px-4">
                    @csrf
                    <button type="submit" class="inline-flex items-center rounded-md p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100">
